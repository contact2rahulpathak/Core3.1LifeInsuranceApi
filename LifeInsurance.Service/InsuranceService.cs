...
namespace LifeInsurance.Service
{
    public class InsuranceService : InterfaceLifeInsurance
    {
        private readonly ILifeInsuranceRepository<Contract> _InsuranceRepository;
        public InsuranceService(ILifeInsuranceRepository<Contract> InsuranceRepository)
        {
